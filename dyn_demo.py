...
if __name__ == "__main__":
    ...
    Pre_grab_pos = np.array([-1.05623,  1.02066, -0.57354, -0.9058,   0.41996,  2.91373,  0.90335]) # 12.1
    # Pre_place_pos = np.array([-0.01779206-0.3, -0.76012354,  0.01978261, -2.34205014, 0.02984053, 1.54119353, 0.75344866])
    Pre_place_pos = np.array([-1.08441,  1.25679, -0.51034, -0.90505,  0.45643,  3.15141,  0.91422]) #12.1
